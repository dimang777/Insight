...
# NOT USED
# Sweetness - removed due to redundancy and occasional inaccuracy - i.e., sugar can be used to derive this
# Featured_wines
# Recomm_foods
...
rw_df_mvp_v2 = rw_df.drop(columns=['Sweetness', 'Featured_wines', 'Recomm_foods'])[full_rows_bool]

...
# Save
with open('C:/Users/diman/OneDrive/Work_temp/Insight/LargeData/winetales_cos_dist_v3.pkl', 'wb') as f:
    pickle.dump([winetales_cos_dist], f)
winetales_cos_dist_df = pd.DataFrame(winetales_cos_dist)
winetales_cos_dist_df.to_pickle('C:/Users/diman/OneDrive/Work_temp/Insight/LargeData/winetales_cos_dist_df_v3.pkl')

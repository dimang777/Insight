...
with open('Validation Questions v2.txt', 'w', encoding='utf-8') as text_file:
...
with open('Description pairing v2.txt', 'w', encoding='utf-8') as text_file:
    for idx in range(len(validation100_input_idx)):
...
# Save
with open('C:/Users/diman/OneDrive/Work_temp/Insight/Git_Workspace/data/cleaned/validation100_input_idx_v2.pkl', 'wb') as f:

...
app = Flask(__name__)
rw = redwine_v2.RedWine('rw_df_mvp_v2.xlsx')
...
def tag_output():
    ...
    if id_num == '':
        return render_template("index.html",
                               my_input = id_num,
                               my_form_result="Please enter the number")
    elif id_cate == 0:
        return render_template("index.html",
                               my_input = id_num,
                               my_form_result="Please select the type")
    elif id_cate == 0 and id_num == '':
        return render_template("index.html",
                               my_input = id_num,
                               my_form_result="Please select the type and enter the number")
    else:
        if id_cate == 1:
            id_cate_result = 'L'
        ...
        some_output=id_cate_result+str(id_num)
        some_number=3

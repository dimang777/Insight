# Import libraries
import pandas as pd
from S1_DataScraping import scrape_page_raw, scrape_product, format_data_df, parse_info, read_saved_soup, format_data_df_v2
...
def use_web_toscrape():
    ...
    rw.to_csv('rw_web.csv', index=False)
